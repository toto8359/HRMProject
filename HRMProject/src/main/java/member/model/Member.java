...
public class Member {
	...
	public Member(String member_id, String member_name, String member_password, String member_passwordHint,
			String member_passwordHintAnswer, String member_email, Date member_regDate) {
		super();
