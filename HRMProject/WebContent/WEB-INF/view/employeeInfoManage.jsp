				...
				<c:if test="${employeeListPagePart.hasEmployeeList()}">
					<tr>
						<td colspan="4"><c:if
								...
								<a
									href="employeeInfoManage.do?pageNo=${employeeListPagePart.startPage - 5}">[이전]</a>
								...
								<a
									href="employeeInfoManage.do?pageNo=${employeeListPagePart.startPage + 5}">[다음]</a>
								<!-- custom-button 클래스 추가 -->
							</c:if></td>
					</tr>
				</c:if>
	...
	<form action="employeeInfoManage.do" method="POST">
		<c:if test="${registerForm}">
			<p>
				...
				<c:if test="${!modifyInfo}">
					<label id="employeeNum-label" for="name">employeeNum</label>
					<input type="text" name="employeeNum" placeholder='employeeNum'
			...
			<div class="div-inline">
				<div class="input-group">
					<label id="K-name-label" for="name">K-name</label> <input
						type="text" name="employeePsnl_kname"
						placeholder='employeePsnl_kname'
				...
				<div class="input-group">
					<label id="E-name-label" for="name">E-name</label> <input
						type="text" name="employeePsnl_ename"
						placeholder='employeePsnl_ename'
						class="login-input placeholder-gray"
			...
			<div class="div-inline">
				<div class="input-group">
					...
					<select name="employeePsnl_isForeigner"
						...
						<option value="내국인"
							<c:if test="${param.employeePsnl_isForeigner == '내국인'}">selected</c:if>>내국인</option>
						<option value="외국인"
							<c:if test="${param.employeePsnl_isForeigner == '외국인'}">selected</c:if>>외국인</option>
					</select>
				...
				<div class="input-group">
					...
					<input type="text" name="employeePsnl_residentNumber"
						placeholder='residentNumber' class="login-input placeholder-gray"
			...
			<p>
				<label id="adress" for="employeePsnl_adress">adress</label> <input
					type="text" name="employeePsnl_adress" placeholder='adress'
					class="login-input placeholder-gray"
			...
			<p>
				...
				<input type="text" name="employeePsnl_phoneNumber"
					placeholder='adress' class="login-input placeholder-gray"
			...
			<div class="div-inline">
				<div class="input-group">
					<label id="email" for="employeePsnl_email">email</label> <input
						type="text" name="employeePsnl_email" placeholder='adress'
						class="login-input placeholder-gray"
			...
			<div class="div-inline">
				<div class="input-group">
					...
					<select name="employeeEply_employType" id="employeeEply_employType"
						class="custom-select">
						<option value="정사원"
							<c:if test="${param.employeeEply_employType == '정사원'}">selected</c:if>>정사원</option>
						<option value="계약직"
							<c:if test="${param.employeeEply_employType == '계약직'}">selected</c:if>>계약직</option>
					</select>
			...
			<div class="div-inline">
				<div class="input-group">
					<label id="joinDate" for="employeePsnl_joinDate">joinDate</label> <input
						type="text" name="employeeEply_join" id="employeeEply_join"
						placeholder='joinDate' class="login-input placeholder-gray"
				...
				<div class="input-group">
					...
					<input type="text" name="employeeEply_resignation"
						id="employeeEply_resignation" placeholder='resignationDate'
						class="login-input placeholder-gray"
				...
				<!-- 삭제하기 버튼 -->
					<form action="employeeInfoManage.do" method="POST"
						...
						<input type="hidden" name="employeeNumDelete"
							...
							type="submit" value="삭제" class="custom-button delete-button">
					</form>
				</div>
		</div>
